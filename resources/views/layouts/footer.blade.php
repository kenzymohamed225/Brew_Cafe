    ...
    <div class="container">
        <div class="row g-4 text-center text-md-start">
            <div class="col-md-4">
                ...
                <p class="small opacity-75">Crafting perfection in every cup. Visit us daily for fresh coffee, artisanal
                    pastries, and a cozy atmosphere.</p>
            </div>
            <div class="col-md-4 text-center">
                ...
                <ul class="list-unstyled small d-flex flex-column gap-2 mb-0">
                    ...
                    <li><a href="{{ route('gallery.index') }}"class="text-decoration-none text-light opacity-75">PhotoGallery</a></li>
