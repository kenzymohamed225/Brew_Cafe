...
@section('content')
    ...
    <section class="gallery-hero py-5 text-white position-relative"
        style="background: linear-gradient(rgba(43, 26, 14, 0.88), rgba(60, 36, 21, 0.92)), url('{{ asset('assets/images/coffe.jpg') }}') center/cover no-repeat;">
        <div class="container py-4 text-center">
            ...
            <p class="lead opacity-85 mx-auto mb-4" style="max-width: 650px;">
                Step into the world of Brew Café. From hand-poured artisanal coffee to handcrafted pastries and cozy
                ambiance, explore our curated gallery of daily moments.
            </p>
                ...
                <div class="row g-4" id="galleryGrid">
                    @foreach ($galleryItems as $item)
                        <div class="col-sm-6 col-md-4 col-lg-3 gallery-item-wrapper"
                            data-category="{{ Str::slug($item->category ?? 'other') }}">
                            <div class="card h-100 border-0 shadow-sm gallery-card overflow-hidden rounded-4">
                                <div class="gallery-img-container position-relative overflow-hidden">
                                    <img src="{{ $item->image_url }}" class="card-img-top gallery-img w-100"
                                        alt="{{ $item->title }}" loading="lazy" style="height: 240px; object-fit: cover;">

                                    <div class="gallery-overlay d-flex flex-column justify-content-end p-3">
                                        @if ($item->category)
                                            <span
                                                class="badge bg-light text-dark align-self-start mb-2 px-2 py-1 small rounded-pill shadow-sm">
                                                {{ $item->category }}
                                            </span>
                                        @endif
                                ...
                                <div class="card-body p-3 bg-white d-flex flex-column">
                                    <div class="d-flex justify-content-between align-items-start mb-1">
                                        ...
                                        @if ($item->category)
                                            <span
                                                class="badge bg-secondary-subtle text-secondary small px-2 py-1 rounded-pill"
    ...
    <div class="modal fade" id="galleryLightboxModal" tabindex="-1" aria-labelledby="lightboxTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content bg-dark border-0 text-white rounded-4 overflow-hidden shadow-lg">
                ...
                <div class="modal-body p-0 text-center bg-black position-relative d-flex align-items-center justify-content-center"
                    style="min-height: 380px; max-height: 75vh;">
                ...
                <div class="modal-footer border-0 bg-dark p-4 d-flex flex-column align-items-start">
                    <div class="d-flex align-items-center gap-2 mb-2 w-100">
                        <span id="lightboxCategory"
                            class="badge bg-warning text-dark px-2.5 py-1 rounded-pill fw-semibold"></span>
